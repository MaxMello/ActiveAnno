[activeannoservice](../../index.md) / [config.filter](../index.md) / [Equals](./index.md)

# Equals

`class Equals : `[`FilterCondition`](../-filter-condition/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Equals(key: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`, value: `[`Any`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/index.html)`?)`<br>Use for direct equals or array contains |
