[activeannoservice](../../index.md) / [config.filter](../index.md) / [In](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `In(key: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`, value: `[`List`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)`<`[`Any`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/index.html)`?>)` |
