[activeannoservice](../../index.md) / [config.export](../index.md) / [Export](index.md) / [onOverwrittenFinalizedAnnotationBehavior](./on-overwritten-finalized-annotation-behavior.md)
