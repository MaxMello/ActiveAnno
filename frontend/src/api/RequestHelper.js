...
import {httpError} from "../types/TypeCreators";
 ...
 */
export const requestConfig = (method: any, data?: Object, jwt?: JWT): Object => ({
    method: method,
    headers: jwt ? {...defaultHeaders(), ...{'Authorization': `Bearer ${jwt.token}`}} : defaultHeaders(),
